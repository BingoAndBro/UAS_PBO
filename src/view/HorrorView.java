 ...
 * @author bingoandbro
 */
public class HorrorView extends javax.swing.JFrame {
    ...
    public HorrorView() {
       username = GlobalVariabel.getUser().getUsername();
        ...
        this.database = Database.getInstance();
         ...
         table_horror.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
         
        refreshTable();
        HorrorView.this.getRootPane().setBorder(new LineBorder(new Color(76, 41, 211)));
    ...
    private void initComponents() {
        ...
        table_horror = new javax.swing.JTable();
        ...
        lblTitle.setText("Kenangan Horror");
        pnlTitle.add(lblTitle);
        ...
        horror_label.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        ...
        table_horror.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
            ...
            new String [] {
                "Identitas", "Kenangan Horror", "Last Modified"
            }
        ) {
        ...
        jScrollPane1.setViewportView(table_horror);
            ...
            .addGroup(pnlDataCardsLayout.createSequentialGroup()
                ...
                .addGroup(pnlDataCardsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlDataCardsLayout.createSequentialGroup()
                        ...
                        .addGap(112, 436, Short.MAX_VALUE))
    ...
    private void refreshTable() {
        ...
        List<KenanganHorror> kenangan_HorrorList = database.getAllKenangan_Horror();
    
        DefaultTableModel model = (DefaultTableModel) table_horror.getModel();
        model.setRowCount(0); // Clear existing data
    
        for (KenanganHorror m : kenangan_HorrorList) {
    ...
    private void lblMaximizeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMaximizeMousePressed
        if (HorrorView.this.getExtendedState() == MAXIMIZED_BOTH) {
            HorrorView.this.setExtendedState(JFrame.NORMAL);
        } else {
            HorrorView.this.setExtendedState(MAXIMIZED_BOTH);
        }
    ...
    private void lblMinimizeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMinimizeMousePressed
        HorrorView.this.setState(Frame.ICONIFIED);
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        // TODO add your handling code here:
         int selectedRow = table_horror.getSelectedRow();
                if (selectedRow != -1) {
                    final String identitas = (String) table_horror.getValueAt(selectedRow, 0); // Ambil data dari kolom pertama
                    final String kenangan = (String) table_horror.getValueAt(selectedRow, 1); // Ambil data dari kolom kedua
                    String username = database.cariUsernameHorror(identitas);
                    
                     if (username != null && username.equals(GlobalVariabel.getUser().getUsername()))   {
                        java.awt.EventQueue.invokeLater(new Runnable() {
                            @Override
                            public void run() {
                                new HorrorRegisterView(identitas,kenangan).setVisible(true);
                                HorrorView.this.dispose();
                            }
                        });
                    } else {
...
//            String data1 = kenanganUsernameMap.get(key); // Ambil username dari map
          ...
          if (username != null && username.equals(GlobalVariabel.getUser().getUsername()))   {
            try {
                database.deleteDataHorror(username,identitas,kenangan); // Hapus data dari database
                ((DefaultTableModel) table_horror.getModel()).removeRow(selectedRow); // Hapus data dari tabel
    ...
    private void exportButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_exportButtonMouseClicked
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                database.exportTableToCSV(table_horror, new File(fileToSave + ".csv"));
    ...
    private void importButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_importButtonMouseClicked
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                database.importTableFromCSV(table_horror, fileToOpen);
    ...
    private javax.swing.JTable table_horror;
