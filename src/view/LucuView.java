 ...
 * @author bingoandbro
 */
public class LucuView extends javax.swing.JFrame {
    private CardLayout cardLayout;
     private Database database;
     private String username;
      private Map<String, String> kenanganUsernameMap; // Map untuk menyimpan username berdasarkan identitas dan kenangan
   ...
   // private javax.swing.Jtable table_lucu;
    ...
    public LucuView() {
        ...
        kenanganUsernameMap = new HashMap<>();
        
        
        
        table_lucu.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        
        refreshTable();
        LucuView.this.getRootPane().setBorder(new LineBorder(new Color(76, 41, 211)));
    ...
    private void initComponents() {
        ...
        table_lucu = new javax.swing.JTable();
        ...
        lblTitle.setText("Kenangan Lucu");
        pnlTitle.add(lblTitle);
        ...
        lucu_label.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        ...
        table_lucu.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
            ...
            new String [] {
                "Identitas", "Kenangan Lucu", "Last Modified"
            }
        ) {
        ...
        jScrollPane2.setViewportView(table_lucu);
                        ...
                        .addGroup(pnlDataCardsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(pnlDataCardsLayout.createSequentialGroup()
                                ...
                                .addGroup(pnlDataCardsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(importButton, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void refreshTable() {
        ...
        List<KenanganLucu> kenangan_LucuList = database.getAllKenangan_Lucu();
    
        DefaultTableModel model = (DefaultTableModel) table_lucu.getModel();
        model.setRowCount(0); // Clear existing data
         kenanganUsernameMap.clear(); // Clear existing map data
    
        for (KenanganLucu m : kenangan_LucuList) {
    ...
    private void lblMaximizeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMaximizeMousePressed
        if (LucuView.this.getExtendedState() == MAXIMIZED_BOTH) {
            LucuView.this.setExtendedState(JFrame.NORMAL);
        } else {
            LucuView.this.setExtendedState(MAXIMIZED_BOTH);
        }
    ...
    private void lblMinimizeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMinimizeMousePressed
        LucuView.this.setState(Frame.ICONIFIED);
    ...
    private void importButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_importButtonMouseClicked
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                database.importTableFromCSV(table_lucu, fileToOpen);
    ...
    private void exportButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_exportButtonMouseClicked
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                database.exportTableToCSV(table_lucu, new File(fileToSave + ".csv"));
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        // TODO add your handling code here:
        int selectedRow = table_lucu.getSelectedRow();
        if (selectedRow != -1) {
            final String identitas = (String) table_lucu.getValueAt(selectedRow, 0); // Ambil data dari kolom pertama
            final String kenangan = (String) table_lucu.getValueAt(selectedRow, 1); // Ambil data dari kolom kedua
            String username = database.cariUsernameLucu(identitas);
            ...
            if (username != null && username.equals(GlobalVariabel.getUser().getUsername()))   {
                try {
                    database.deleteDataLucu(username,identitas,kenangan); // Hapus data dari database
                    ((DefaultTableModel) table_lucu.getModel()).removeRow(selectedRow); // Hapus data dari tabel
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        int selectedRow = table_lucu.getSelectedRow();
        if (selectedRow != -1) {
            String identitas = (String) table_lucu.getValueAt(selectedRow, 0); // Ambil data dari kolom pertama
            String kenangan = (String) table_lucu.getValueAt(selectedRow, 1); // Ambil data dari kolom kedua
            String username = database.cariUsernameLucu(identitas);

            //String key = identitas + kenangan;
            //                String data1 = kenanganUsernameMap.get(identitas+kenangan); // Ambil username dari map
            ...
            if (username != null && username.equals(GlobalVariabel.getUser().getUsername()))   {
                java.awt.EventQueue.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        ...
                        new LucuRegisterView(identitas, kenangan).setVisible(true);
                        LucuView.this.dispose();
                    }
                });
            } else {
...
//            java.util.logging.Logger.getLogger(LucuView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            @Override
//            public void run() {
//                new LucuView(coba).setVisible(true);
//            }
//        });
//    }
