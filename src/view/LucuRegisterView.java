 ...
 * @author bingoandbro
 */
public class LucuRegisterView extends javax.swing.JFrame implements Observer {
   // private javax.swing.Jtable table_lucu;
    ...
    public LucuRegisterView(String identitas,String kenangan) {
        username = GlobalVariabel.getUser().getUsername(); //simpan username saat login
        initComponents();
                // Simpan data asli untuk referensi saat menyimpan
        ...
        kenanganField.setText(kenangan);
        
        // Menonaktifkan tombol "Input" jika ada data lama
        if (identitas != null && !identitas.isEmpty() && kenangan != null && !kenangan.isEmpty()) {
            inputButton.setEnabled(false);
        }
        
   
        LucuRegisterView.this.getRootPane().setBorder(new LineBorder(new Color(76, 41, 211)));
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Tambah Kenangan Lucu");
        pnlTitle.add(lblTitle);
        ...
        jLabel4.setText("FORM TAMBAH KENANGAN LUCU");

        userLabel.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        userLabel.setText("Identitas :");
    ...
    private void lblMaximizeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMaximizeMousePressed
        if (LucuRegisterView.this.getExtendedState() == MAXIMIZED_BOTH) {
            LucuRegisterView.this.setExtendedState(JFrame.NORMAL);
        } else {
            LucuRegisterView.this.setExtendedState(MAXIMIZED_BOTH);
        }
    ...
    private void lblMinimizeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMinimizeMousePressed
        LucuRegisterView.this.setState(Frame.ICONIFIED);
    ...
    private void inputButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inputButtonActionPerformed
      ...
      try {
        ...
        kenanganLucu.setUsername(username); // Set username saat login
            kenanganLucu.setIdentitas(identitas); // Set identitas yang diinput oleh pengguna
            kenanganLucu.setKenangan(kenangan);
            kenanganLucu.setLastModified(getCurrentDate());
            
        RegisterKenanganController registerKenanganController = new RegisterKenanganController();

        if (registerKenanganController.insertKenanganLucu(kenanganLucu)) {
            JOptionPane.showMessageDialog(this, "Kenangan telah diinput!");
            new LucuView().setVisible(true);
            this.dispose();
        } else {
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
       ...
       if (originalIdentitas == null || originalKenangan == null || originalIdentitas.isEmpty() || originalKenangan.isEmpty()) {
        ...
        try {
            database.saveUpdatedDataLucu(username,originalIdentitas, originalKenangan, newIdentitas, newKenangan);
    ...
    public static void main(String[] args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HorrorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new LucuRegisterView( "","").setVisible(true);
            }
        });
    }
