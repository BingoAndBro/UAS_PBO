 ...
 * @author bingoandbro
 */
public class HorrorRegisterView extends javax.swing.JFrame implements Observer {
   // private javax.swing.Jtable table_lucu;
    ...
    public HorrorRegisterView(String identitas, String kenangan) {
        ...
        HorrorRegisterView.this.getRootPane().setBorder(new LineBorder(new Color(76, 41, 211)));
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Tambah Kenangan Horror");
        pnlTitle.add(lblTitle);
        ...
        jLabel4.setText("FORM TAMBAH KENANGAN HORROR");
    ...
    private void lblMaximizeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMaximizeMousePressed
        if (HorrorRegisterView.this.getExtendedState() == MAXIMIZED_BOTH) {
            HorrorRegisterView.this.setExtendedState(JFrame.NORMAL);
        } else {
            HorrorRegisterView.this.setExtendedState(MAXIMIZED_BOTH);
        }
    ...
    private void lblMinimizeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMinimizeMousePressed
        HorrorRegisterView.this.setState(Frame.ICONIFIED);
    ...
    try {
        ...
        KenanganHorror kenanganHorror = new KenanganHorror(identitas, kenangan);
        kenanganHorror.setUsername(username); // Set username saat login
            kenanganHorror.setIdentitas(identitas); // Set identitas yang diinput oleh pengguna
            kenanganHorror.setKenangan(kenangan);
            kenanganHorror.setLastModified(getCurrentDate());

        RegisterKenanganController registerKenanganController = new RegisterKenanganController();

        if (registerKenanganController.insertKenanganHorror(kenanganHorror)) {
            JOptionPane.showMessageDialog(this, "Kenangan telah diinput!");
            new HorrorView().setVisible(true);
            this.dispose();
        } else {
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        try {
            database.saveUpdatedDataHorror(username,originalIdentitas, originalKenangan, newIdentitas, newKenangan);
